...
Public Class Soporte
    ...
    Private Sub btnBuscarFechas_Click(sender As Object, e As EventArgs) Handles btnBuscarFechas.Click
        Try
            ...
            consultas.insOrden(DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss"), txtCliente.Text, txtTelefono.Text, txtEquipo.Text,
            ...
            If txtAnticipo.Text = "0" Or txtAnticipo.Text = "" Then

            Else
                consultas.insSale(24, 1, Date.Today.ToString("yyyy-MM-dd"), DateTime.Now.ToShortTimeString, "Anticipo Orden", txtAnticipo.Text)
            End If
            ...
            ticketOrden.Encabezado("ESTADO: " & cbEstado.Text)
            If cbChip.Text = "No" Then
                ticketOrden.Encabezado("CHIP: NO")
            Else
                ticketOrden.Encabezado("CHIP: SI")
            End If
            If cbMemoria.Text = "No" Then
            ...
            ticketOrden.Encabezado("FECHA ENTREGA: " & dtpFecha.Value.ToShortDateString)
            ticketOrden.Encabezado("HORA ENTREGA: " & dtpFecha.Value.ToShortTimeString)
            ...
            ticketOrden.Pago("RESTANTE", Val(txtCoste.Text) - Val(txtAnticipo.Text))
